...
# functionResults = fasta.read_sequences_from_fasta_file(sarscov2_sequence_filename)
# sarscov2_sequence_name = functionResults[0][0]
# sarscov2_sequence = functionResults[0][1]
